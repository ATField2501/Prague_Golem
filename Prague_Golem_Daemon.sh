...
daemon_OPT="-d -p -f /home/cagliostro/Prague_Golem/Prague_Golem_Daemon.ini"  #argument à utiliser par le programme - Remplacer Utilisateur par votre nom de login
